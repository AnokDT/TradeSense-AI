...
def main_menu():
    while True:
        print("\n" + "=" * 45)
        print("TradeSense AI - Strategy Research Framework")
        print("=" * 45)
        print("1. Run Daily Market Analysis")
        print("2. Run Strategy Backtests")
...
if __name__ == "__main__":
    # If arguments are passed (e.g. from tests), we can handle them
    if len(sys.argv) > 1:
        arg = sys.argv[1]
        if arg == "analysis":
            run_daily_analysis()
